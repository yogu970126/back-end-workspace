...
//		b.method1();
	...
	public void method1() {
		 ...
		 * - 단순히 값만 저장하는 것이 아니라, 값의 존재 여부를 확인하고 값이 존재하지 않을 결우 디폴트 값을 설정할 수 있는 객체
		 * */
		double average = Arrays.stream(array).average().getAsDouble(); // get : 저장되어 있는 값을 얻기 위해 사용
		...
		// ifPresent : 값이 저장되어 있을 경우 처리
		first.ifPresent(value -> System.out.println("첫번째 값 : " + value));
	}
	
	/*
	 * 커스텀 집계
	 * - 스트림에서 기본 집계 메서드를 제공하지만 다양한 집게 결과물을 만들 수 있도록 reduce 메서드를 제공한다.
	 * */
	public void method2() {
