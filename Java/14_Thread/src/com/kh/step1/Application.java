 ...
 * - 하나의 스레드는 하나의 코드 실행 흐름이기 때문에 한 프로세스 내에 여러 개의 스레드가 존재한다면
 *   여러 개의 실행 흐름이 생긴다는 의미
 *   
 * * 메인 스레드
 ...
 * - 하나의 프로세스 내부에 여러개의 스레드가 생성되기 때문에 하나의 스레드가 에외를 발생시키면 프로세스 자체가 종료될 수 있다
 * 
 * * 장점
 * - 시스템 자원을 보다 효율적으로 사용
